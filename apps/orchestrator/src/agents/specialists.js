...
exports.specialistForBranch = specialistForBranch;
exports.specialistDisplayName = specialistDisplayName;
const SPECIALISTS = {
    finance: {
        kind: 'finance',
...
function specialistForBranch(branch) {
...
function specialistDisplayName(specialist, branch) {
